...
| | Цільове |
|---|---|
| Image size | 640×640 (match style anchor) |
| Bbox min-side px | ≥10 (детекція), ≥20 (класифікація) |
| Bbox median | ~60 px (per `_synthetic_apc_726`) |
| Стратифікація | висота 300/400/600/800м × кут 10-60° × 4 сезони × ландшафти |
| Метадані | JSON sidecar обов'язковий |
